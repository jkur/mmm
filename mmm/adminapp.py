...
from mmm.models import Account, Domain, Alias, User

def register_admin(app, db):
    with app.app_context():
        from mmm.admin_views import Account_View, Alias_View, User_View, Domain_View
        ...
        admin.add_view(User_View(User, db.session, name='Users'))
